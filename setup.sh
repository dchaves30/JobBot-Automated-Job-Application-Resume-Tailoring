...
mkdir -p /{backend,frontend/src,bot}
...
cat > /backend/openai_utils.py << EOF
import openai
import os
from dotenv import load_dotenv
...
echo "Next steps:"
echo "1. Add your real OpenAI API key in backend/.env"
echo "2. From /, run: docker-compose up --build"
echo "3. Visit http://localhost:3000 (frontend) and http://localhost:8000/docs (API docs)"
echo "------------------------------------------"
